...
import {
  ...
  Schedule,
  HalfOfDonors,
} from '@/components/event-result-own-event';
      ...
      <Card>
        <CardHeader className="sm:flex-col">
          <div className="flex flex-col sm:flex-row sm:justify-between w-full">
            <Breadcrumb title="Result of Own Event" items={breadcrumbItems} />
...
export default EventResultOwnEvent;
