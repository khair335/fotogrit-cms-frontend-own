...
const TableModifyTopUp = (props) => {
  ...
  const walletAmount = data?.data?.data;
      ...
      {isError ? (
        ...
        <div className="border-t border-gray-200">
          <DataTable
            ...
            persistTableHead
            noDataComponent={<NoDataMessage title="Top Up Wallet" />}
          />
...
export default TableModifyTopUp;
