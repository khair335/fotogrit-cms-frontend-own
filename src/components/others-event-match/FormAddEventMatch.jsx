...
import { useAddNewEventMatchMutation } from '@/services/api/othersApiSlice';
...
const FormAddEventMatch = ({ setOpenColapse }) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const [addNewEventMatch, { isLoading, error: errServer }] =
  ...
  const handleOnSubmit = async () => {
    try {
      ...
      const response = await addNewEventMatch(newData).unwrap();
...
export default FormAddEventMatch;
