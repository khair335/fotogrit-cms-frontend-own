...
import TableTeamManager from './TableTeamManager';
import FormDetailTeamManager from './FormDetailTeamManager';

import useDebounce from '@/hooks/useDebounce';
import { useGetTeamMasterQuery } from '@/services/api/teamMasterApiSlice';

const RequestTeamManager = () => {
  ...
  return (
    <>
      ...
      <section>
        ...
        {/* MODAL */}
        <Modal
          title="Detail Request as Team Manager"
          openModal={openModal}
          setOpenModal={setOpenModal}
        >
          <FormDetailTeamManager
            data={getDetailData}
            setOpenModal={setOpenModal}
          />
        </Modal>
...
export default RequestTeamManager;
