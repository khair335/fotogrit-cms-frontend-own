...
import TableManageRequest from './TableManageRequest';
import FormDetailManageRequest from './FormDetailManageRequest';
  ...
  return (
    <>
      ...
      <section>
        ...
        {/* MODAL */}
        <Modal
          title="Detail Manage Request"
          openModal={openModal}
          setOpenModal={setOpenModal}
        >
          <FormDetailManageRequest
            data={getDetailData}
            setOpenModal={setOpenModal}
          />
        </Modal>
