...
const FormAddUserBenefits = (props) => {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="z-10 flex flex-col gap-4">
            ...
            <SelectDropdown
              ...
              name="users"
              data={optionsUsers}
              label="Select All Users who will get Benefits"
              placeholder="Select User"
              selectedValue={selectedUsers}
              setSelectedValue={setSelectedUsers}
              // errServer={errServer?.data}
              // errCodeServer="x01013"
              // errValidation={errors}
              // infiniteScroll
              // setPageOption={setPageOption}
              // setSearchQueryOption={setSearchQueryOption}
...
export default FormAddUserBenefits;
